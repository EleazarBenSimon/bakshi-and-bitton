...
const i18n = {
  he: {
    ...
    label_tags: "תיוגים",
    label_notes: "הערות",
    label_adversarial: "הוגנות אדברסרית — העמדה הנגדית",
    adversarial_note: "פרשנות, לא תיעוד: זוהי העמדה התומכת בפסיקה, המובאת לשם איזון. הליבה התיעודית שלמעלה מציינת עובדות הליכיות בלבד.",
  ...
  en: {
    ...
    label_tags: "Tags",
    label_notes: "Notes",
    label_adversarial: "Adversarial fairness — the opposing view",
    adversarial_note: "Interpretation, not documentation: this states the case FOR the ruling, for balance. The documentary core above records procedural facts only.",
